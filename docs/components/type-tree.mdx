...
<Info>
  Learn more about TypeInfo in the [comprehensive TypeInfo guide](/snippets/type-info), including how to explore available types, access nested properties, and best practices.
</Info>
...
<Preview title="Auto-generated from TypeScript source">
  <TypeTree {...TypeInfo.MintTsdocs.ResolvedConfig} />
</Preview>
