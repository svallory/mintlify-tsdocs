...
### liquidEngine
**Modifiers**: readonly
**Type**:<Link kind="ref" target="mint-tsdocs.LiquidTemplateEngine">`get liquidEngine(): LiquidTemplateEngine;`</Link>
**Default**: ``
...
**Modifiers**: readonly
**Type**:<Link kind="ref" target="mint-tsdocs.TemplateDataConverter">`get templateDataConverter(): TemplateDataConverter;`</Link>
**Default**: ``
