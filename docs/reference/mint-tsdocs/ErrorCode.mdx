...
Provides structured error information for better error handling and debugging. These codes are used to categorize errors and allow for programmatic handling.   string 
## Members
