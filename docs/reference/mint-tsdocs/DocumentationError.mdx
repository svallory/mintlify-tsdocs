...
Base class for all custom errors in the documentation generation process. It extends the native <code>Error</code> class with additional structured context.   Error 
## Signature
...
### code
**Modifiers**: readonly
**Type**:<Link kind="ref" target="mint-tsdocs.ErrorCode">`readonly code: ErrorCode;`</Link>
**Default**: ``
...
### context
**Modifiers**: readonly
**Type**:<Link kind="ref" target="mint-tsdocs.ErrorContext">`readonly context: ErrorContext;`</Link>
**Default**: ``
