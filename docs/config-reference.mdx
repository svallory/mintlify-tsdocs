...
Configuration for TSDoc parser.
...
Paths to TSDoc configuration files to extend.
...
**Common extends:**
- `@microsoft/api-extractor/extends/tsdoc-base.json` - Base TSDoc tags
- Custom tsdoc.json files in your project

---

#### tsdoc.tagDefinitions

**Type:** `array`

Custom TSDoc tag definitions.
...
**Tag properties:**
- `tagName` - Tag name (e.g., `@experimental`)
- `syntaxKind` - Tag type: `modifier`, `block`, or `inline`
...
Configuration for API report file generation (optional).
...
**Properties:**
- `enabled` - Whether to generate API report
- `reportFolder` - Output directory
- `reportFileName` - Report file name pattern
...
Configuration for .d.ts rollup generation (optional).
...
**Properties:**
- `enabled` - Whether to generate rollup
- `publicTrimmedFilePath` - Public API .d.ts output
- `betaTrimmedFilePath` - Beta API .d.ts output
- `alphaTrimmedFilePath` - Alpha API .d.ts output
- `untrimmedFilePath` - Full API .d.ts output
